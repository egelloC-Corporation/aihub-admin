...
# Generated by scripts/bootstrap-vps.sh on $(date -Iseconds)
VPS_ROLE=${VPS_ROLE}
...
ACQ_DB_HOST=${ACQ_DB_HOST:-}
ACQ_DB_PORT=${ACQ_DB_PORT:-25060}
ACQ_DB_NAME=${ACQ_DB_NAME:-defaultdb}
INCUBATOR_LOG_DB_USER=${INCUBATOR_LOG_DB_USER:-}
INCUBATOR_LOG_DB_PASSWORD=${INCUBATOR_LOG_DB_PASSWORD:-}
EOF
  umask 022
else
